...
compiler::TNode<JSArray> ArrayMapBuiltinsFromDSLAssembler::FastArrayMap(compiler::TNode<Context> p_context, compiler::TNode<JSArray> p_fastO, compiler::TNode<Smi> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<JSArray>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1) {
  ...
  if (block54.is_used()) {
    ...
    USE(tmp1024);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp1024 = BaseBuiltinsFromDSLAssembler(state_).Cast22UT12ATHeapNumber5ATSmi(compiler::TNode<Object>{tmp1023}, &label0);
  ...
  if (block60.is_used()) {
    ...
    USE(tmp1082);
    tmp1082 = ca_.UncheckedCast<Float64T>(BaseBuiltinsFromDSLAssembler(state_).Convert9ATfloat6422UT12ATHeapNumber5ATSmi(compiler::TNode<Number>{tmp1081}));
    compiler::TNode<Float64T> tmp1083;
    USE(tmp1083);
    tmp1083 = ca_.UncheckedCast<Float64T>(CodeStubAssembler(state_).Float64SilenceNaN(compiler::TNode<Float64T>{tmp1082}));
    CodeStubAssembler(state_).StoreFixedDoubleArrayElementSmi(compiler::TNode<FixedDoubleArray>{tmp1077}, compiler::TNode<Smi>{tmp1078}, compiler::TNode<Float64T>{tmp1083});
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 129);
  ...
  if (block59.is_used()) {
    ...
    compiler::TNode<Context> tmp1102;
    compiler::TNode<Smi> tmp1103;
    compiler::TNode<Smi> tmp1104;
    compiler::TNode<Int32T> tmp1105;
    compiler::TNode<Map> tmp1106;
    compiler::TNode<JSArray> tmp1107;
    compiler::TNode<FixedDoubleArray> tmp1108;
    compiler::TNode<Smi> tmp1109;
    compiler::TNode<Object> tmp1110;
    ca_.Bind(&block59, &tmp1084, &tmp1085, &tmp1086, &tmp1087, &tmp1088, &tmp1089, &tmp1090, &tmp1091, &tmp1092, &tmp1093, &tmp1094, &tmp1095, &tmp1096, &tmp1097, &tmp1098, &tmp1099, &tmp1100, &tmp1101, &tmp1102, &tmp1103, &tmp1104, &tmp1105, &tmp1106, &tmp1107, &tmp1108, &tmp1109, &tmp1110);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 132);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 133);
    compiler::TNode<Oddball> tmp1111;
    USE(tmp1111);
    tmp1111 = BaseBuiltinsFromDSLAssembler(state_).Hole();
    compiler::TNode<BoolT> tmp1112;
    USE(tmp1112);
    tmp1112 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).WordEqual(compiler::TNode<Object>{ca_.UncheckedCast<HeapObject>(tmp1110)}, compiler::TNode<HeapObject>{tmp1111}));
    ca_.Branch(tmp1112, &block62, &block63, tmp1084, tmp1085, tmp1086, tmp1087, tmp1088, tmp1089, tmp1090, tmp1091, tmp1092, tmp1093, tmp1094, tmp1095, tmp1096, tmp1097, tmp1098, tmp1099, tmp1100, tmp1101, tmp1102, tmp1103, tmp1104, tmp1105, tmp1106, tmp1107, tmp1108, tmp1109, tmp1110, ca_.UncheckedCast<HeapObject>(tmp1110));
  }
  ...
  if (block63.is_used()) {
    ...
    compiler::TNode<Context> tmp1131;
    compiler::TNode<Smi> tmp1132;
    compiler::TNode<Smi> tmp1133;
    compiler::TNode<Int32T> tmp1134;
    compiler::TNode<Map> tmp1135;
    compiler::TNode<JSArray> tmp1136;
    compiler::TNode<FixedDoubleArray> tmp1137;
    compiler::TNode<Smi> tmp1138;
    compiler::TNode<Object> tmp1139;
    compiler::TNode<HeapObject> tmp1140;
    ca_.Bind(&block63, &tmp1113, &tmp1114, &tmp1115, &tmp1116, &tmp1117, &tmp1118, &tmp1119, &tmp1120, &tmp1121, &tmp1122, &tmp1123, &tmp1124, &tmp1125, &tmp1126, &tmp1127, &tmp1128, &tmp1129, &tmp1130, &tmp1131, &tmp1132, &tmp1133, &tmp1134, &tmp1135, &tmp1136, &tmp1137, &tmp1138, &tmp1139, &tmp1140);
  ...
  if (block62.is_used()) {
    ...
    compiler::TNode<Int32T> tmp1162;
    compiler::TNode<Map> tmp1163;
    compiler::TNode<JSArray> tmp1164;
    compiler::TNode<FixedDoubleArray> tmp1165;
    compiler::TNode<Smi> tmp1166;
    compiler::TNode<Object> tmp1167;
    compiler::TNode<HeapObject> tmp1168;
    ca_.Bind(&block62, &tmp1141, &tmp1142, &tmp1143, &tmp1144, &tmp1145, &tmp1146, &tmp1147, &tmp1148, &tmp1149, &tmp1150, &tmp1151, &tmp1152, &tmp1153, &tmp1154, &tmp1155, &tmp1156, &tmp1157, &tmp1158, &tmp1159, &tmp1160, &tmp1161, &tmp1162, &tmp1163, &tmp1164, &tmp1165, &tmp1166, &tmp1167, &tmp1168);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 129);
    ca_.Goto(&block58, tmp1141, tmp1142, tmp1143, tmp1144, tmp1145, tmp1146, tmp1147, tmp1148, tmp1149, tmp1150, tmp1151, tmp1152, tmp1153, tmp1154, tmp1155, tmp1156, tmp1157, tmp1158, tmp1159, tmp1160, tmp1161, tmp1162, tmp1163, tmp1164, tmp1165, tmp1166, tmp1167);
  }

  if (block58.is_used()) {
    compiler::TNode<Context> tmp1169;
    compiler::TNode<JSArray> tmp1170;
    compiler::TNode<Smi> tmp1171;
    compiler::TNode<JSReceiver> tmp1172;
    compiler::TNode<Object> tmp1173;
    compiler::TNode<Smi> tmp1174;
    compiler::TNode<JSArray> tmp1175;
    compiler::TNode<JSArray> tmp1176;
    compiler::TNode<Map> tmp1177;
    compiler::TNode<BoolT> tmp1178;
    compiler::TNode<BoolT> tmp1179;
    compiler::TNode<BoolT> tmp1180;
    compiler::TNode<FixedArray> tmp1181;
    ...
    compiler::TNode<Context> tmp1187;
    ...
    compiler::TNode<FixedDoubleArray> tmp1193;
    compiler::TNode<Smi> tmp1194;
    compiler::TNode<Object> tmp1195;
    ca_.Bind(&block58, &tmp1169, &tmp1170, &tmp1171, &tmp1172, &tmp1173, &tmp1174, &tmp1175, &tmp1176, &tmp1177, &tmp1178, &tmp1179, &tmp1180, &tmp1181, &tmp1182, &tmp1183, &tmp1184, &tmp1185, &tmp1186, &tmp1187, &tmp1188, &tmp1189, &tmp1190, &tmp1191, &tmp1192, &tmp1193, &tmp1194, &tmp1195);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 128);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 127);
    ca_.Goto(&block57, tmp1169, tmp1170, tmp1171, tmp1172, tmp1173, tmp1174, tmp1175, tmp1176, tmp1177, tmp1178, tmp1179, tmp1180, tmp1181, tmp1182, tmp1183, tmp1184, tmp1185, tmp1186, tmp1187, tmp1188, tmp1189, tmp1190, tmp1191, tmp1192, tmp1193, tmp1194);
  }
  ...
  if (block57.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1199;
    ...
    compiler::TNode<FixedArray> tmp1208;
    ...
    compiler::TNode<Map> tmp1218;
    compiler::TNode<JSArray> tmp1219;
    compiler::TNode<FixedDoubleArray> tmp1220;
    compiler::TNode<Smi> tmp1221;
    ca_.Bind(&block57, &tmp1196, &tmp1197, &tmp1198, &tmp1199, &tmp1200, &tmp1201, &tmp1202, &tmp1203, &tmp1204, &tmp1205, &tmp1206, &tmp1207, &tmp1208, &tmp1209, &tmp1210, &tmp1211, &tmp1212, &tmp1213, &tmp1214, &tmp1215, &tmp1216, &tmp1217, &tmp1218, &tmp1219, &tmp1220, &tmp1221);
    compiler::TNode<Smi> tmp1222;
    USE(tmp1222);
    tmp1222 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(1));
    compiler::TNode<Smi> tmp1223;
    USE(tmp1223);
    tmp1223 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp1221}, compiler::TNode<Smi>{tmp1222}));
    ca_.Goto(&block56, tmp1196, tmp1197, tmp1198, tmp1199, tmp1200, tmp1201, tmp1202, tmp1203, tmp1204, tmp1205, tmp1206, tmp1207, tmp1208, tmp1209, tmp1210, tmp1211, tmp1212, tmp1213, tmp1214, tmp1215, tmp1216, tmp1217, tmp1218, tmp1219, tmp1220, tmp1223);
  }
  ...
  if (block55.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1227;
    compiler::TNode<Object> tmp1228;
    ...
    compiler::TNode<FixedArray> tmp1236;
    ...
    compiler::TNode<Int32T> tmp1245;
    compiler::TNode<Map> tmp1246;
    compiler::TNode<JSArray> tmp1247;
    compiler::TNode<FixedDoubleArray> tmp1248;
    compiler::TNode<Smi> tmp1249;
    ca_.Bind(&block55, &tmp1224, &tmp1225, &tmp1226, &tmp1227, &tmp1228, &tmp1229, &tmp1230, &tmp1231, &tmp1232, &tmp1233, &tmp1234, &tmp1235, &tmp1236, &tmp1237, &tmp1238, &tmp1239, &tmp1240, &tmp1241, &tmp1242, &tmp1243, &tmp1244, &tmp1245, &tmp1246, &tmp1247, &tmp1248, &tmp1249);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 137);
    BaseBuiltinsFromDSLAssembler(state_).StoreJSObjectElements(compiler::TNode<JSObject>{tmp1247}, compiler::TNode<FixedArrayBase>{tmp1248});
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 120);
    ca_.Goto(&block53, tmp1224, tmp1225, tmp1226, tmp1227, tmp1228, tmp1229, tmp1230, tmp1231, tmp1232, tmp1233, tmp1234, tmp1235, tmp1236, tmp1237, tmp1238, tmp1239, tmp1240, tmp1241, tmp1242, tmp1243, tmp1244, tmp1245, tmp1246, tmp1247);
  }
  ...
  if (block52.is_used()) {
    ...
    compiler::TNode<Int32T> tmp1271;
    compiler::TNode<Map> tmp1272;
    compiler::TNode<JSArray> tmp1273;
    ca_.Bind(&block52, &tmp1250, &tmp1251, &tmp1252, &tmp1253, &tmp1254, &tmp1255, &tmp1256, &tmp1257, &tmp1258, &tmp1259, &tmp1260, &tmp1261, &tmp1262, &tmp1263, &tmp1264, &tmp1265, &tmp1266, &tmp1267, &tmp1268, &tmp1269, &tmp1270, &tmp1271, &tmp1272, &tmp1273);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 140);
    compiler::TNode<JSArray> tmp1274;
    USE(tmp1274);
    tmp1274 = ca_.UncheckedCast<JSArray>(BaseBuiltinsFromDSLAssembler(state_).NewJSArray(compiler::TNode<Context>{tmp1268}, compiler::TNode<Map>{tmp1272}, compiler::TNode<FixedArrayBase>{tmp1262}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 120);
    ca_.Goto(&block53, tmp1250, tmp1251, tmp1252, tmp1253, tmp1254, tmp1255, tmp1256, tmp1257, tmp1258, tmp1259, tmp1260, tmp1261, tmp1262, tmp1263, tmp1264, tmp1265, tmp1266, tmp1267, tmp1268, tmp1269, tmp1270, tmp1271, tmp1272, tmp1274);
  }

  if (block53.is_used()) {
    compiler::TNode<Context> tmp1275;
    compiler::TNode<JSArray> tmp1276;
    compiler::TNode<Smi> tmp1277;
    compiler::TNode<JSReceiver> tmp1278;
    compiler::TNode<Object> tmp1279;
    compiler::TNode<Smi> tmp1280;
    compiler::TNode<JSArray> tmp1281;
    compiler::TNode<JSArray> tmp1282;
    compiler::TNode<Map> tmp1283;
    ...
    compiler::TNode<Context> tmp1293;
    compiler::TNode<Smi> tmp1294;
    compiler::TNode<Smi> tmp1295;
    compiler::TNode<Int32T> tmp1296;
    compiler::TNode<Map> tmp1297;
    compiler::TNode<JSArray> tmp1298;
    ca_.Bind(&block53, &tmp1275, &tmp1276, &tmp1277, &tmp1278, &tmp1279, &tmp1280, &tmp1281, &tmp1282, &tmp1283, &tmp1284, &tmp1285, &tmp1286, &tmp1287, &tmp1288, &tmp1289, &tmp1290, &tmp1291, &tmp1292, &tmp1293, &tmp1294, &tmp1295, &tmp1296, &tmp1297, &tmp1298);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 144);
    compiler::TNode<FixedArray> tmp1299;
    USE(tmp1299);
    tmp1299 = BaseBuiltinsFromDSLAssembler(state_).kEmptyFixedArray();
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 145);
    ca_.Goto(&block40, tmp1275, tmp1276, tmp1277, tmp1278, tmp1279, tmp1280, tmp1281, tmp1282, tmp1283, tmp1284, tmp1285, tmp1286, tmp1299, tmp1288, tmp1289, tmp1290, tmp1291, tmp1292, tmp1293, tmp1294, tmp1298);
  }

  if (block40.is_used()) {
    compiler::TNode<Context> tmp1300;
    compiler::TNode<JSArray> tmp1301;
    compiler::TNode<Smi> tmp1302;
    compiler::TNode<JSReceiver> tmp1303;
    compiler::TNode<Object> tmp1304;
    compiler::TNode<Smi> tmp1305;
    compiler::TNode<JSArray> tmp1306;
    compiler::TNode<JSArray> tmp1307;
    compiler::TNode<Map> tmp1308;
    ...
    compiler::TNode<Context> tmp1318;
    compiler::TNode<Smi> tmp1319;
    compiler::TNode<JSArray> tmp1320;
    ca_.Bind(&block40, &tmp1300, &tmp1301, &tmp1302, &tmp1303, &tmp1304, &tmp1305, &tmp1306, &tmp1307, &tmp1308, &tmp1309, &tmp1310, &tmp1311, &tmp1312, &tmp1313, &tmp1314, &tmp1315, &tmp1316, &tmp1317, &tmp1318, &tmp1319, &tmp1320);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 212);
    ca_.Goto(&block1, tmp1320, tmp1316);
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Bind(&block3, &tmp1321, &tmp1322, &tmp1323, &tmp1324, &tmp1325, &tmp1326, &tmp1327, &tmp1328, &tmp1329, &tmp1330, &tmp1331, &tmp1332, &tmp1333, &tmp1334, &tmp1335, &tmp1336);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 215);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 97);
    compiler::TNode<Smi> tmp1337;
    USE(tmp1337);
    tmp1337 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).LoadFixedArrayBaseLength(compiler::TNode<FixedArrayBase>{tmp1333}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 98);
    compiler::TNode<BoolT> tmp1338;
    USE(tmp1338);
    tmp1338 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiLessThanOrEqual(compiler::TNode<Smi>{tmp1323}, compiler::TNode<Smi>{tmp1337}));
    ca_.Branch(tmp1338, &block65, &block66, tmp1321, tmp1322, tmp1323, tmp1324, tmp1325, tmp1326, tmp1327, tmp1328, tmp1329, tmp1330, tmp1331, tmp1332, tmp1333, tmp1334, tmp1335, tmp1336, tmp1323, tmp1321, tmp1323, tmp1337);
  }

  if (block66.is_used()) {
    compiler::TNode<Context> tmp1339;
    compiler::TNode<JSArray> tmp1340;
    ...
    compiler::TNode<Map> tmp1347;
    compiler::TNode<BoolT> tmp1348;
    compiler::TNode<BoolT> tmp1349;
    compiler::TNode<BoolT> tmp1350;
    compiler::TNode<FixedArray> tmp1351;
    compiler::TNode<BoolT> tmp1352;
    compiler::TNode<BoolT> tmp1353;
    compiler::TNode<BoolT> tmp1354;
    compiler::TNode<Smi> tmp1355;
    compiler::TNode<Context> tmp1356;
    compiler::TNode<Smi> tmp1357;
    compiler::TNode<Smi> tmp1358;
    ca_.Bind(&block66, &tmp1339, &tmp1340, &tmp1341, &tmp1342, &tmp1343, &tmp1344, &tmp1345, &tmp1346, &tmp1347, &tmp1348, &tmp1349, &tmp1350, &tmp1351, &tmp1352, &tmp1353, &tmp1354, &tmp1355, &tmp1356, &tmp1357, &tmp1358);
    CodeStubAssembler(state_).FailAssert("Torque assert \'validLength <= length\' failed", "../../src/builtins/array-map.tq", 98);
  }
  ...
  if (block65.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1362;
    compiler::TNode<Object> tmp1363;
    compiler::TNode<Smi> tmp1364;
    compiler::TNode<JSArray> tmp1365;
    compiler::TNode<JSArray> tmp1366;
    compiler::TNode<Map> tmp1367;
    compiler::TNode<BoolT> tmp1368;
    compiler::TNode<BoolT> tmp1369;
    compiler::TNode<BoolT> tmp1370;
    compiler::TNode<FixedArray> tmp1371;
    compiler::TNode<BoolT> tmp1372;
    compiler::TNode<BoolT> tmp1373;
    compiler::TNode<BoolT> tmp1374;
    compiler::TNode<Smi> tmp1375;
    compiler::TNode<Context> tmp1376;
    compiler::TNode<Smi> tmp1377;
    compiler::TNode<Smi> tmp1378;
    ca_.Bind(&block65, &tmp1359, &tmp1360, &tmp1361, &tmp1362, &tmp1363, &tmp1364, &tmp1365, &tmp1366, &tmp1367, &tmp1368, &tmp1369, &tmp1370, &tmp1371, &tmp1372, &tmp1373, &tmp1374, &tmp1375, &tmp1376, &tmp1377, &tmp1378);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 99);
    compiler::TNode<Int32T> tmp1379;
    USE(tmp1379);
    tmp1379 = ca_.UncheckedCast<Int32T>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind(PACKED_SMI_ELEMENTS));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 100);
    compiler::TNode<BoolT> tmp1380;
    USE(tmp1380);
    tmp1380 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).Word32BinaryNot(compiler::TNode<BoolT>{tmp1372}));
    ca_.Branch(tmp1380, &block67, &block68, tmp1359, tmp1360, tmp1361, tmp1362, tmp1363, tmp1364, tmp1365, tmp1366, tmp1367, tmp1368, tmp1369, tmp1370, tmp1371, tmp1372, tmp1373, tmp1374, tmp1375, tmp1376, tmp1377, tmp1378, tmp1379);
  }
  ...
  if (block67.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1384;
    compiler::TNode<Object> tmp1385;
    compiler::TNode<Smi> tmp1386;
    compiler::TNode<JSArray> tmp1387;
    compiler::TNode<JSArray> tmp1388;
    compiler::TNode<Map> tmp1389;
    compiler::TNode<BoolT> tmp1390;
    compiler::TNode<BoolT> tmp1391;
    compiler::TNode<BoolT> tmp1392;
    compiler::TNode<FixedArray> tmp1393;
    compiler::TNode<BoolT> tmp1394;
    compiler::TNode<BoolT> tmp1395;
    compiler::TNode<BoolT> tmp1396;
    compiler::TNode<Smi> tmp1397;
    compiler::TNode<Context> tmp1398;
    compiler::TNode<Smi> tmp1399;
    compiler::TNode<Smi> tmp1400;
    compiler::TNode<Int32T> tmp1401;
    ca_.Bind(&block67, &tmp1381, &tmp1382, &tmp1383, &tmp1384, &tmp1385, &tmp1386, &tmp1387, &tmp1388, &tmp1389, &tmp1390, &tmp1391, &tmp1392, &tmp1393, &tmp1394, &tmp1395, &tmp1396, &tmp1397, &tmp1398, &tmp1399, &tmp1400, &tmp1401);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 101);
    ca_.Branch(tmp1395, &block69, &block70, tmp1381, tmp1382, tmp1383, tmp1384, tmp1385, tmp1386, tmp1387, tmp1388, tmp1389, tmp1390, tmp1391, tmp1392, tmp1393, tmp1394, tmp1395, tmp1396, tmp1397, tmp1398, tmp1399, tmp1400, tmp1401);
  }

  if (block69.is_used()) {
    compiler::TNode<Context> tmp1402;
    compiler::TNode<JSArray> tmp1403;
    compiler::TNode<Smi> tmp1404;
    compiler::TNode<JSReceiver> tmp1405;
    compiler::TNode<Object> tmp1406;
    compiler::TNode<Smi> tmp1407;
    compiler::TNode<JSArray> tmp1408;
    compiler::TNode<JSArray> tmp1409;
    compiler::TNode<Map> tmp1410;
    compiler::TNode<BoolT> tmp1411;
    compiler::TNode<BoolT> tmp1412;
    compiler::TNode<BoolT> tmp1413;
    compiler::TNode<FixedArray> tmp1414;
    compiler::TNode<BoolT> tmp1415;
    compiler::TNode<BoolT> tmp1416;
    compiler::TNode<BoolT> tmp1417;
    compiler::TNode<Smi> tmp1418;
    compiler::TNode<Context> tmp1419;
    compiler::TNode<Smi> tmp1420;
    compiler::TNode<Smi> tmp1421;
    compiler::TNode<Int32T> tmp1422;
    ca_.Bind(&block69, &tmp1402, &tmp1403, &tmp1404, &tmp1405, &tmp1406, &tmp1407, &tmp1408, &tmp1409, &tmp1410, &tmp1411, &tmp1412, &tmp1413, &tmp1414, &tmp1415, &tmp1416, &tmp1417, &tmp1418, &tmp1419, &tmp1420, &tmp1421, &tmp1422);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 102);
    compiler::TNode<Int32T> tmp1423;
    USE(tmp1423);
    tmp1423 = ca_.UncheckedCast<Int32T>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind(PACKED_DOUBLE_ELEMENTS));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 101);
    ca_.Goto(&block71, tmp1402, tmp1403, tmp1404, tmp1405, tmp1406, tmp1407, tmp1408, tmp1409, tmp1410, tmp1411, tmp1412, tmp1413, tmp1414, tmp1415, tmp1416, tmp1417, tmp1418, tmp1419, tmp1420, tmp1421, tmp1423);
  }

  if (block70.is_used()) {
    compiler::TNode<Context> tmp1424;
    compiler::TNode<JSArray> tmp1425;
    compiler::TNode<Smi> tmp1426;
    compiler::TNode<JSReceiver> tmp1427;
    compiler::TNode<Object> tmp1428;
    compiler::TNode<Smi> tmp1429;
    compiler::TNode<JSArray> tmp1430;
    compiler::TNode<JSArray> tmp1431;
    compiler::TNode<Map> tmp1432;
    compiler::TNode<BoolT> tmp1433;
    compiler::TNode<BoolT> tmp1434;
    compiler::TNode<BoolT> tmp1435;
    compiler::TNode<FixedArray> tmp1436;
    compiler::TNode<BoolT> tmp1437;
    compiler::TNode<BoolT> tmp1438;
    compiler::TNode<BoolT> tmp1439;
    ...
    ca_.Bind(&block70, &tmp1424, &tmp1425, &tmp1426, &tmp1427, &tmp1428, &tmp1429, &tmp1430, &tmp1431, &tmp1432, &tmp1433, &tmp1434, &tmp1435, &tmp1436, &tmp1437, &tmp1438, &tmp1439, &tmp1440, &tmp1441, &tmp1442, &tmp1443, &tmp1444);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 104);
    compiler::TNode<Int32T> tmp1445;
    USE(tmp1445);
    tmp1445 = ca_.UncheckedCast<Int32T>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind(PACKED_ELEMENTS));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 101);
    ca_.Goto(&block71, tmp1424, tmp1425, tmp1426, tmp1427, tmp1428, tmp1429, tmp1430, tmp1431, tmp1432, tmp1433, tmp1434, tmp1435, tmp1436, tmp1437, tmp1438, tmp1439, tmp1440, tmp1441, tmp1442, tmp1443, tmp1445);
  }

  if (block71.is_used()) {
    compiler::TNode<Context> tmp1446;
    compiler::TNode<JSArray> tmp1447;
    compiler::TNode<Smi> tmp1448;
    compiler::TNode<JSReceiver> tmp1449;
    compiler::TNode<Object> tmp1450;
    compiler::TNode<Smi> tmp1451;
    compiler::TNode<JSArray> tmp1452;
    compiler::TNode<JSArray> tmp1453;
    compiler::TNode<Map> tmp1454;
    compiler::TNode<BoolT> tmp1455;
    compiler::TNode<BoolT> tmp1456;
    compiler::TNode<BoolT> tmp1457;
    compiler::TNode<FixedArray> tmp1458;
    compiler::TNode<BoolT> tmp1459;
    compiler::TNode<BoolT> tmp1460;
    compiler::TNode<BoolT> tmp1461;
    compiler::TNode<Smi> tmp1462;
    compiler::TNode<Context> tmp1463;
    compiler::TNode<Smi> tmp1464;
    compiler::TNode<Smi> tmp1465;
    compiler::TNode<Int32T> tmp1466;
    ca_.Bind(&block71, &tmp1446, &tmp1447, &tmp1448, &tmp1449, &tmp1450, &tmp1451, &tmp1452, &tmp1453, &tmp1454, &tmp1455, &tmp1456, &tmp1457, &tmp1458, &tmp1459, &tmp1460, &tmp1461, &tmp1462, &tmp1463, &tmp1464, &tmp1465, &tmp1466);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 100);
    ca_.Goto(&block68, tmp1446, tmp1447, tmp1448, tmp1449, tmp1450, tmp1451, tmp1452, tmp1453, tmp1454, tmp1455, tmp1456, tmp1457, tmp1458, tmp1459, tmp1460, tmp1461, tmp1462, tmp1463, tmp1464, tmp1465, tmp1466);
  }
  ...
  if (block68.is_used()) {
    ...
    ca_.Bind(&block68, &tmp1467, &tmp1468, &tmp1469, &tmp1470, &tmp1471, &tmp1472, &tmp1473, &tmp1474, &tmp1475, &tmp1476, &tmp1477, &tmp1478, &tmp1479, &tmp1480, &tmp1481, &tmp1482, &tmp1483, &tmp1484, &tmp1485, &tmp1486, &tmp1487);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 108);
    ca_.Branch(tmp1482, &block72, &block74, tmp1467, tmp1468, tmp1469, tmp1470, tmp1471, tmp1472, tmp1473, tmp1474, tmp1475, tmp1476, tmp1477, tmp1478, tmp1479, tmp1480, tmp1481, tmp1482, tmp1483, tmp1484, tmp1485, tmp1486, tmp1487);
  }

  if (block74.is_used()) {
    compiler::TNode<Context> tmp1488;
    compiler::TNode<JSArray> tmp1489;
    compiler::TNode<Smi> tmp1490;
    compiler::TNode<JSReceiver> tmp1491;
    compiler::TNode<Object> tmp1492;
    compiler::TNode<Smi> tmp1493;
    compiler::TNode<JSArray> tmp1494;
    compiler::TNode<JSArray> tmp1495;
    compiler::TNode<Map> tmp1496;
    compiler::TNode<BoolT> tmp1497;
    compiler::TNode<BoolT> tmp1498;
    compiler::TNode<BoolT> tmp1499;
    compiler::TNode<FixedArray> tmp1500;
    compiler::TNode<BoolT> tmp1501;
    compiler::TNode<BoolT> tmp1502;
    compiler::TNode<BoolT> tmp1503;
    compiler::TNode<Smi> tmp1504;
    compiler::TNode<Context> tmp1505;
    compiler::TNode<Smi> tmp1506;
    compiler::TNode<Smi> tmp1507;
    compiler::TNode<Int32T> tmp1508;
    ca_.Bind(&block74, &tmp1488, &tmp1489, &tmp1490, &tmp1491, &tmp1492, &tmp1493, &tmp1494, &tmp1495, &tmp1496, &tmp1497, &tmp1498, &tmp1499, &tmp1500, &tmp1501, &tmp1502, &tmp1503, &tmp1504, &tmp1505, &tmp1506, &tmp1507, &tmp1508);
    compiler::TNode<BoolT> tmp1509;
    USE(tmp1509);
    tmp1509 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiLessThan(compiler::TNode<Smi>{tmp1506}, compiler::TNode<Smi>{tmp1507}));
    ca_.Branch(tmp1509, &block72, &block73, tmp1488, tmp1489, tmp1490, tmp1491, tmp1492, tmp1493, tmp1494, tmp1495, tmp1496, tmp1497, tmp1498, tmp1499, tmp1500, tmp1501, tmp1502, tmp1503, tmp1504, tmp1505, tmp1506, tmp1507, tmp1508);
  }

  if (block72.is_used()) {
    compiler::TNode<Context> tmp1510;
    compiler::TNode<JSArray> tmp1511;
    compiler::TNode<Smi> tmp1512;
    compiler::TNode<JSReceiver> tmp1513;
    compiler::TNode<Object> tmp1514;
    compiler::TNode<Smi> tmp1515;
    compiler::TNode<JSArray> tmp1516;
    compiler::TNode<JSArray> tmp1517;
    compiler::TNode<Map> tmp1518;
    compiler::TNode<BoolT> tmp1519;
    compiler::TNode<BoolT> tmp1520;
    compiler::TNode<BoolT> tmp1521;
    compiler::TNode<FixedArray> tmp1522;
    compiler::TNode<BoolT> tmp1523;
    compiler::TNode<BoolT> tmp1524;
    compiler::TNode<BoolT> tmp1525;
    compiler::TNode<Smi> tmp1526;
    compiler::TNode<Context> tmp1527;
    compiler::TNode<Smi> tmp1528;
    compiler::TNode<Smi> tmp1529;
    compiler::TNode<Int32T> tmp1530;
    ca_.Bind(&block72, &tmp1510, &tmp1511, &tmp1512, &tmp1513, &tmp1514, &tmp1515, &tmp1516, &tmp1517, &tmp1518, &tmp1519, &tmp1520, &tmp1521, &tmp1522, &tmp1523, &tmp1524, &tmp1525, &tmp1526, &tmp1527, &tmp1528, &tmp1529, &tmp1530);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 114);
    compiler::TNode<Int32T> tmp1531;
    USE(tmp1531);
    tmp1531 = ca_.UncheckedCast<Int32T>(BaseBuiltinsFromDSLAssembler(state_).FastHoleyElementsKind(compiler::TNode<Int32T>{tmp1530}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 108);
    ca_.Goto(&block73, tmp1510, tmp1511, tmp1512, tmp1513, tmp1514, tmp1515, tmp1516, tmp1517, tmp1518, tmp1519, tmp1520, tmp1521, tmp1522, tmp1523, tmp1524, tmp1525, tmp1526, tmp1527, tmp1528, tmp1529, tmp1531);
  }

  if (block73.is_used()) {
    compiler::TNode<Context> tmp1532;
    compiler::TNode<JSArray> tmp1533;
    compiler::TNode<Smi> tmp1534;
    compiler::TNode<JSReceiver> tmp1535;
    compiler::TNode<Object> tmp1536;
    compiler::TNode<Smi> tmp1537;
    compiler::TNode<JSArray> tmp1538;
    compiler::TNode<JSArray> tmp1539;
    compiler::TNode<Map> tmp1540;
    compiler::TNode<BoolT> tmp1541;
    compiler::TNode<BoolT> tmp1542;
    compiler::TNode<BoolT> tmp1543;
    compiler::TNode<FixedArray> tmp1544;
    compiler::TNode<BoolT> tmp1545;
    compiler::TNode<BoolT> tmp1546;
    compiler::TNode<BoolT> tmp1547;
    compiler::TNode<Smi> tmp1548;
    compiler::TNode<Context> tmp1549;
    compiler::TNode<Smi> tmp1550;
    compiler::TNode<Smi> tmp1551;
    compiler::TNode<Int32T> tmp1552;
    ca_.Bind(&block73, &tmp1532, &tmp1533, &tmp1534, &tmp1535, &tmp1536, &tmp1537, &tmp1538, &tmp1539, &tmp1540, &tmp1541, &tmp1542, &tmp1543, &tmp1544, &tmp1545, &tmp1546, &tmp1547, &tmp1548, &tmp1549, &tmp1550, &tmp1551, &tmp1552);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 117);
    compiler::TNode<Context> tmp1553;
    USE(tmp1553);
    tmp1553 = ca_.UncheckedCast<Context>(CodeStubAssembler(state_).LoadNativeContext(compiler::TNode<Context>{tmp1549}));
    compiler::TNode<Map> tmp1554;
    USE(tmp1554);
    tmp1554 = ca_.UncheckedCast<Map>(CodeStubAssembler(state_).LoadJSArrayElementsMap(compiler::TNode<Int32T>{tmp1552}, compiler::TNode<Context>{tmp1553}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 118);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 120);
    compiler::TNode<BoolT> tmp1555;
    USE(tmp1555);
    tmp1555 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).IsDoubleElementsKind(compiler::TNode<Int32T>{tmp1552}));
    ca_.Branch(tmp1555, &block75, &block76, tmp1532, tmp1533, tmp1534, tmp1535, tmp1536, tmp1537, tmp1538, tmp1539, tmp1540, tmp1541, tmp1542, tmp1543, tmp1544, tmp1545, tmp1546, tmp1547, tmp1548, tmp1549, tmp1550, tmp1551, tmp1552, tmp1554, ca_.Uninitialized<JSArray>());
  }
  ...
  if (block75.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1559;
    compiler::TNode<Object> tmp1560;
    compiler::TNode<Smi> tmp1561;
    compiler::TNode<JSArray> tmp1562;
    compiler::TNode<JSArray> tmp1563;
    compiler::TNode<Map> tmp1564;
    ...
    compiler::TNode<BoolT> tmp1571;
    compiler::TNode<Smi> tmp1572;
    compiler::TNode<Context> tmp1573;
    compiler::TNode<Smi> tmp1574;
    compiler::TNode<Smi> tmp1575;
    compiler::TNode<Int32T> tmp1576;
    compiler::TNode<Map> tmp1577;
    compiler::TNode<JSArray> tmp1578;
    ca_.Bind(&block75, &tmp1556, &tmp1557, &tmp1558, &tmp1559, &tmp1560, &tmp1561, &tmp1562, &tmp1563, &tmp1564, &tmp1565, &tmp1566, &tmp1567, &tmp1568, &tmp1569, &tmp1570, &tmp1571, &tmp1572, &tmp1573, &tmp1574, &tmp1575, &tmp1576, &tmp1577, &tmp1578);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 125);
    compiler::TNode<IntPtrT> tmp1579;
    USE(tmp1579);
    tmp1579 = ca_.UncheckedCast<IntPtrT>(CodeStubAssembler(state_).SmiUntag(compiler::TNode<Smi>{tmp1575}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 124);
    compiler::TNode<FixedDoubleArray> tmp1580;
    USE(tmp1580);
    tmp1580 = ca_.UncheckedCast<FixedDoubleArray>(CodeStubAssembler(state_).AllocateFixedDoubleArrayWithHoles(compiler::TNode<IntPtrT>{tmp1579}, CodeStubAssembler::kAllowLargeObjectAllocation));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 126);
    compiler::TNode<JSArray> tmp1581;
    USE(tmp1581);
    tmp1581 = ca_.UncheckedCast<JSArray>(BaseBuiltinsFromDSLAssembler(state_).NewJSArray(compiler::TNode<Context>{tmp1573}, compiler::TNode<Map>{tmp1577}, compiler::TNode<FixedArrayBase>{tmp1568}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 127);
    ...
    ca_.Goto(&block80, tmp1556, tmp1557, tmp1558, tmp1559, tmp1560, tmp1561, tmp1562, tmp1563, tmp1564, tmp1565, tmp1566, tmp1567, tmp1568, tmp1569, tmp1570, tmp1571, tmp1572, tmp1573, tmp1574, tmp1575, tmp1576, tmp1577, tmp1581, tmp1580, tmp1582);
  }

  if (block80.is_used()) {
    compiler::TNode<Context> tmp1583;
    compiler::TNode<JSArray> tmp1584;
    compiler::TNode<Smi> tmp1585;
    compiler::TNode<JSReceiver> tmp1586;
    compiler::TNode<Object> tmp1587;
    compiler::TNode<Smi> tmp1588;
    compiler::TNode<JSArray> tmp1589;
    compiler::TNode<JSArray> tmp1590;
    compiler::TNode<Map> tmp1591;
    ...
    compiler::TNode<Context> tmp1600;
    compiler::TNode<Smi> tmp1601;
    compiler::TNode<Smi> tmp1602;
    compiler::TNode<Int32T> tmp1603;
    compiler::TNode<Map> tmp1604;
    compiler::TNode<JSArray> tmp1605;
    compiler::TNode<FixedDoubleArray> tmp1606;
    compiler::TNode<Smi> tmp1607;
    ca_.Bind(&block80, &tmp1583, &tmp1584, &tmp1585, &tmp1586, &tmp1587, &tmp1588, &tmp1589, &tmp1590, &tmp1591, &tmp1592, &tmp1593, &tmp1594, &tmp1595, &tmp1596, &tmp1597, &tmp1598, &tmp1599, &tmp1600, &tmp1601, &tmp1602, &tmp1603, &tmp1604, &tmp1605, &tmp1606, &tmp1607);
    compiler::TNode<BoolT> tmp1608;
    USE(tmp1608);
    tmp1608 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiLessThan(compiler::TNode<Smi>{tmp1607}, compiler::TNode<Smi>{tmp1601}));
    ca_.Branch(tmp1608, &block78, &block79, tmp1583, tmp1584, tmp1585, tmp1586, tmp1587, tmp1588, tmp1589, tmp1590, tmp1591, tmp1592, tmp1593, tmp1594, tmp1595, tmp1596, tmp1597, tmp1598, tmp1599, tmp1600, tmp1601, tmp1602, tmp1603, tmp1604, tmp1605, tmp1606, tmp1607);
  }

  if (block78.is_used()) {
    compiler::TNode<Context> tmp1609;
    compiler::TNode<JSArray> tmp1610;
    compiler::TNode<Smi> tmp1611;
    compiler::TNode<JSReceiver> tmp1612;
    compiler::TNode<Object> tmp1613;
    compiler::TNode<Smi> tmp1614;
    compiler::TNode<JSArray> tmp1615;
    compiler::TNode<JSArray> tmp1616;
    compiler::TNode<Map> tmp1617;
    ...
    compiler::TNode<BoolT> tmp1624;
    compiler::TNode<Smi> tmp1625;
    compiler::TNode<Context> tmp1626;
    compiler::TNode<Smi> tmp1627;
    compiler::TNode<Smi> tmp1628;
    compiler::TNode<Int32T> tmp1629;
    compiler::TNode<Map> tmp1630;
    compiler::TNode<JSArray> tmp1631;
    compiler::TNode<FixedDoubleArray> tmp1632;
    compiler::TNode<Smi> tmp1633;
    ca_.Bind(&block78, &tmp1609, &tmp1610, &tmp1611, &tmp1612, &tmp1613, &tmp1614, &tmp1615, &tmp1616, &tmp1617, &tmp1618, &tmp1619, &tmp1620, &tmp1621, &tmp1622, &tmp1623, &tmp1624, &tmp1625, &tmp1626, &tmp1627, &tmp1628, &tmp1629, &tmp1630, &tmp1631, &tmp1632, &tmp1633);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 128);
    compiler::TNode<Object> tmp1634;
    USE(tmp1634);
    tmp1634 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).LoadFixedArrayElement(compiler::TNode<FixedArray>{tmp1621}, compiler::TNode<Smi>{tmp1633}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 129);
    compiler::TNode<Number> tmp1635;
    USE(tmp1635);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp1635 = BaseBuiltinsFromDSLAssembler(state_).Cast22UT12ATHeapNumber5ATSmi(compiler::TNode<Object>{tmp1634}, &label0);
    ca_.Goto(&block84, tmp1609, tmp1610, tmp1611, tmp1612, tmp1613, tmp1614, tmp1615, tmp1616, tmp1617, tmp1618, tmp1619, tmp1620, tmp1621, tmp1622, tmp1623, tmp1624, tmp1625, tmp1626, tmp1627, tmp1628, tmp1629, tmp1630, tmp1631, tmp1632, tmp1633, tmp1634, tmp1634, tmp1635);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block85, tmp1609, tmp1610, tmp1611, tmp1612, tmp1613, tmp1614, tmp1615, tmp1616, tmp1617, tmp1618, tmp1619, tmp1620, tmp1621, tmp1622, tmp1623, tmp1624, tmp1625, tmp1626, tmp1627, tmp1628, tmp1629, tmp1630, tmp1631, tmp1632, tmp1633, tmp1634, tmp1634);
    }
  }
  ...
  if (block85.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1639;
    compiler::TNode<Object> tmp1640;
    compiler::TNode<Smi> tmp1641;
    compiler::TNode<JSArray> tmp1642;
    compiler::TNode<JSArray> tmp1643;
    compiler::TNode<Map> tmp1644;
    ...
    compiler::TNode<Context> tmp1653;
    compiler::TNode<Smi> tmp1654;
    compiler::TNode<Smi> tmp1655;
    compiler::TNode<Int32T> tmp1656;
    compiler::TNode<Map> tmp1657;
    compiler::TNode<JSArray> tmp1658;
    compiler::TNode<FixedDoubleArray> tmp1659;
    compiler::TNode<Smi> tmp1660;
    compiler::TNode<Object> tmp1661;
    compiler::TNode<Object> tmp1662;
    ca_.Bind(&block85, &tmp1636, &tmp1637, &tmp1638, &tmp1639, &tmp1640, &tmp1641, &tmp1642, &tmp1643, &tmp1644, &tmp1645, &tmp1646, &tmp1647, &tmp1648, &tmp1649, &tmp1650, &tmp1651, &tmp1652, &tmp1653, &tmp1654, &tmp1655, &tmp1656, &tmp1657, &tmp1658, &tmp1659, &tmp1660, &tmp1661, &tmp1662);
    ca_.Goto(&block83, tmp1636, tmp1637, tmp1638, tmp1639, tmp1640, tmp1641, tmp1642, tmp1643, tmp1644, tmp1645, tmp1646, tmp1647, tmp1648, tmp1649, tmp1650, tmp1651, tmp1652, tmp1653, tmp1654, tmp1655, tmp1656, tmp1657, tmp1658, tmp1659, tmp1660, tmp1661);
  }
  ...
  if (block84.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1666;
    compiler::TNode<Object> tmp1667;
    compiler::TNode<Smi> tmp1668;
    compiler::TNode<JSArray> tmp1669;
    compiler::TNode<JSArray> tmp1670;
    compiler::TNode<Map> tmp1671;
    compiler::TNode<BoolT> tmp1672;
    compiler::TNode<BoolT> tmp1673;
    compiler::TNode<BoolT> tmp1674;
    compiler::TNode<FixedArray> tmp1675;
    compiler::TNode<BoolT> tmp1676;
    compiler::TNode<BoolT> tmp1677;
    compiler::TNode<BoolT> tmp1678;
    compiler::TNode<Smi> tmp1679;
    compiler::TNode<Context> tmp1680;
    compiler::TNode<Smi> tmp1681;
    compiler::TNode<Smi> tmp1682;
    compiler::TNode<Int32T> tmp1683;
    compiler::TNode<Map> tmp1684;
    compiler::TNode<JSArray> tmp1685;
    compiler::TNode<FixedDoubleArray> tmp1686;
    compiler::TNode<Smi> tmp1687;
    compiler::TNode<Object> tmp1688;
    compiler::TNode<Object> tmp1689;
    compiler::TNode<Number> tmp1690;
    ca_.Bind(&block84, &tmp1663, &tmp1664, &tmp1665, &tmp1666, &tmp1667, &tmp1668, &tmp1669, &tmp1670, &tmp1671, &tmp1672, &tmp1673, &tmp1674, &tmp1675, &tmp1676, &tmp1677, &tmp1678, &tmp1679, &tmp1680, &tmp1681, &tmp1682, &tmp1683, &tmp1684, &tmp1685, &tmp1686, &tmp1687, &tmp1688, &tmp1689, &tmp1690);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 130);
    compiler::TNode<Float64T> tmp1691;
    USE(tmp1691);
    tmp1691 = ca_.UncheckedCast<Float64T>(BaseBuiltinsFromDSLAssembler(state_).Convert9ATfloat6422UT12ATHeapNumber5ATSmi(compiler::TNode<Number>{tmp1690}));
    compiler::TNode<Float64T> tmp1692;
    USE(tmp1692);
    tmp1692 = ca_.UncheckedCast<Float64T>(CodeStubAssembler(state_).Float64SilenceNaN(compiler::TNode<Float64T>{tmp1691}));
    CodeStubAssembler(state_).StoreFixedDoubleArrayElementSmi(compiler::TNode<FixedDoubleArray>{tmp1686}, compiler::TNode<Smi>{tmp1687}, compiler::TNode<Float64T>{tmp1692});
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 129);
    ca_.Goto(&block82, tmp1663, tmp1664, tmp1665, tmp1666, tmp1667, tmp1668, tmp1669, tmp1670, tmp1671, tmp1672, tmp1673, tmp1674, tmp1675, tmp1676, tmp1677, tmp1678, tmp1679, tmp1680, tmp1681, tmp1682, tmp1683, tmp1684, tmp1685, tmp1686, tmp1687, tmp1688);
  }

  if (block83.is_used()) {
    compiler::TNode<Context> tmp1693;
    compiler::TNode<JSArray> tmp1694;
    compiler::TNode<Smi> tmp1695;
    compiler::TNode<JSReceiver> tmp1696;
    compiler::TNode<Object> tmp1697;
    compiler::TNode<Smi> tmp1698;
    compiler::TNode<JSArray> tmp1699;
    compiler::TNode<JSArray> tmp1700;
    compiler::TNode<Map> tmp1701;
    compiler::TNode<BoolT> tmp1702;
    compiler::TNode<BoolT> tmp1703;
    compiler::TNode<BoolT> tmp1704;
    compiler::TNode<FixedArray> tmp1705;
    compiler::TNode<BoolT> tmp1706;
    compiler::TNode<BoolT> tmp1707;
    compiler::TNode<BoolT> tmp1708;
    compiler::TNode<Smi> tmp1709;
    compiler::TNode<Context> tmp1710;
    compiler::TNode<Smi> tmp1711;
    compiler::TNode<Smi> tmp1712;
    compiler::TNode<Int32T> tmp1713;
    compiler::TNode<Map> tmp1714;
    compiler::TNode<JSArray> tmp1715;
    compiler::TNode<FixedDoubleArray> tmp1716;
    compiler::TNode<Smi> tmp1717;
    compiler::TNode<Object> tmp1718;
    ca_.Bind(&block83, &tmp1693, &tmp1694, &tmp1695, &tmp1696, &tmp1697, &tmp1698, &tmp1699, &tmp1700, &tmp1701, &tmp1702, &tmp1703, &tmp1704, &tmp1705, &tmp1706, &tmp1707, &tmp1708, &tmp1709, &tmp1710, &tmp1711, &tmp1712, &tmp1713, &tmp1714, &tmp1715, &tmp1716, &tmp1717, &tmp1718);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 132);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 133);
    compiler::TNode<Oddball> tmp1719;
    USE(tmp1719);
    tmp1719 = BaseBuiltinsFromDSLAssembler(state_).Hole();
    compiler::TNode<BoolT> tmp1720;
    USE(tmp1720);
    tmp1720 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).WordEqual(compiler::TNode<Object>{ca_.UncheckedCast<HeapObject>(tmp1718)}, compiler::TNode<HeapObject>{tmp1719}));
    ca_.Branch(tmp1720, &block86, &block87, tmp1693, tmp1694, tmp1695, tmp1696, tmp1697, tmp1698, tmp1699, tmp1700, tmp1701, tmp1702, tmp1703, tmp1704, tmp1705, tmp1706, tmp1707, tmp1708, tmp1709, tmp1710, tmp1711, tmp1712, tmp1713, tmp1714, tmp1715, tmp1716, tmp1717, tmp1718, ca_.UncheckedCast<HeapObject>(tmp1718));
  }
  ...
  if (block87.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1724;
    compiler::TNode<Object> tmp1725;
    compiler::TNode<Smi> tmp1726;
    compiler::TNode<JSArray> tmp1727;
    compiler::TNode<JSArray> tmp1728;
    compiler::TNode<Map> tmp1729;
    compiler::TNode<BoolT> tmp1730;
    compiler::TNode<BoolT> tmp1731;
    compiler::TNode<BoolT> tmp1732;
    compiler::TNode<FixedArray> tmp1733;
    compiler::TNode<BoolT> tmp1734;
    compiler::TNode<BoolT> tmp1735;
    compiler::TNode<BoolT> tmp1736;
    compiler::TNode<Smi> tmp1737;
    compiler::TNode<Context> tmp1738;
    compiler::TNode<Smi> tmp1739;
    compiler::TNode<Smi> tmp1740;
    compiler::TNode<Int32T> tmp1741;
    compiler::TNode<Map> tmp1742;
    compiler::TNode<JSArray> tmp1743;
    compiler::TNode<FixedDoubleArray> tmp1744;
    compiler::TNode<Smi> tmp1745;
    compiler::TNode<Object> tmp1746;
    compiler::TNode<HeapObject> tmp1747;
    ca_.Bind(&block87, &tmp1721, &tmp1722, &tmp1723, &tmp1724, &tmp1725, &tmp1726, &tmp1727, &tmp1728, &tmp1729, &tmp1730, &tmp1731, &tmp1732, &tmp1733, &tmp1734, &tmp1735, &tmp1736, &tmp1737, &tmp1738, &tmp1739, &tmp1740, &tmp1741, &tmp1742, &tmp1743, &tmp1744, &tmp1745, &tmp1746, &tmp1747);
    CodeStubAssembler(state_).FailAssert("Torque assert \'h == Hole\' failed", "../../src/builtins/array-map.tq", 133);
  }

  if (block86.is_used()) {
    compiler::TNode<Context> tmp1748;
    compiler::TNode<JSArray> tmp1749;
    compiler::TNode<Smi> tmp1750;
    compiler::TNode<JSReceiver> tmp1751;
    compiler::TNode<Object> tmp1752;
    compiler::TNode<Smi> tmp1753;
    compiler::TNode<JSArray> tmp1754;
    compiler::TNode<JSArray> tmp1755;
    compiler::TNode<Map> tmp1756;
    compiler::TNode<BoolT> tmp1757;
    compiler::TNode<BoolT> tmp1758;
    compiler::TNode<BoolT> tmp1759;
    compiler::TNode<FixedArray> tmp1760;
    compiler::TNode<BoolT> tmp1761;
    compiler::TNode<BoolT> tmp1762;
    compiler::TNode<BoolT> tmp1763;
    compiler::TNode<Smi> tmp1764;
    compiler::TNode<Context> tmp1765;
    compiler::TNode<Smi> tmp1766;
    compiler::TNode<Smi> tmp1767;
    compiler::TNode<Int32T> tmp1768;
    compiler::TNode<Map> tmp1769;
    compiler::TNode<JSArray> tmp1770;
    compiler::TNode<FixedDoubleArray> tmp1771;
    compiler::TNode<Smi> tmp1772;
    compiler::TNode<Object> tmp1773;
    compiler::TNode<HeapObject> tmp1774;
    ca_.Bind(&block86, &tmp1748, &tmp1749, &tmp1750, &tmp1751, &tmp1752, &tmp1753, &tmp1754, &tmp1755, &tmp1756, &tmp1757, &tmp1758, &tmp1759, &tmp1760, &tmp1761, &tmp1762, &tmp1763, &tmp1764, &tmp1765, &tmp1766, &tmp1767, &tmp1768, &tmp1769, &tmp1770, &tmp1771, &tmp1772, &tmp1773, &tmp1774);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 129);
    ca_.Goto(&block82, tmp1748, tmp1749, tmp1750, tmp1751, tmp1752, tmp1753, tmp1754, tmp1755, tmp1756, tmp1757, tmp1758, tmp1759, tmp1760, tmp1761, tmp1762, tmp1763, tmp1764, tmp1765, tmp1766, tmp1767, tmp1768, tmp1769, tmp1770, tmp1771, tmp1772, tmp1773);
  }

  if (block82.is_used()) {
    compiler::TNode<Context> tmp1775;
    compiler::TNode<JSArray> tmp1776;
    compiler::TNode<Smi> tmp1777;
    compiler::TNode<JSReceiver> tmp1778;
    compiler::TNode<Object> tmp1779;
    compiler::TNode<Smi> tmp1780;
    compiler::TNode<JSArray> tmp1781;
    compiler::TNode<JSArray> tmp1782;
    compiler::TNode<Map> tmp1783;
    compiler::TNode<BoolT> tmp1784;
    compiler::TNode<BoolT> tmp1785;
    compiler::TNode<BoolT> tmp1786;
    compiler::TNode<FixedArray> tmp1787;
    compiler::TNode<BoolT> tmp1788;
    compiler::TNode<BoolT> tmp1789;
    compiler::TNode<BoolT> tmp1790;
    compiler::TNode<Smi> tmp1791;
    compiler::TNode<Context> tmp1792;
    compiler::TNode<Smi> tmp1793;
    compiler::TNode<Smi> tmp1794;
    compiler::TNode<Int32T> tmp1795;
    compiler::TNode<Map> tmp1796;
    compiler::TNode<JSArray> tmp1797;
    compiler::TNode<FixedDoubleArray> tmp1798;
    compiler::TNode<Smi> tmp1799;
    compiler::TNode<Object> tmp1800;
    ca_.Bind(&block82, &tmp1775, &tmp1776, &tmp1777, &tmp1778, &tmp1779, &tmp1780, &tmp1781, &tmp1782, &tmp1783, &tmp1784, &tmp1785, &tmp1786, &tmp1787, &tmp1788, &tmp1789, &tmp1790, &tmp1791, &tmp1792, &tmp1793, &tmp1794, &tmp1795, &tmp1796, &tmp1797, &tmp1798, &tmp1799, &tmp1800);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 128);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 127);
    ca_.Goto(&block81, tmp1775, tmp1776, tmp1777, tmp1778, tmp1779, tmp1780, tmp1781, tmp1782, tmp1783, tmp1784, tmp1785, tmp1786, tmp1787, tmp1788, tmp1789, tmp1790, tmp1791, tmp1792, tmp1793, tmp1794, tmp1795, tmp1796, tmp1797, tmp1798, tmp1799);
  }

  if (block81.is_used()) {
    compiler::TNode<Context> tmp1801;
    compiler::TNode<JSArray> tmp1802;
    compiler::TNode<Smi> tmp1803;
    compiler::TNode<JSReceiver> tmp1804;
    compiler::TNode<Object> tmp1805;
    compiler::TNode<Smi> tmp1806;
    compiler::TNode<JSArray> tmp1807;
    compiler::TNode<JSArray> tmp1808;
    compiler::TNode<Map> tmp1809;
    compiler::TNode<BoolT> tmp1810;
    compiler::TNode<BoolT> tmp1811;
    compiler::TNode<BoolT> tmp1812;
    compiler::TNode<FixedArray> tmp1813;
    compiler::TNode<BoolT> tmp1814;
    compiler::TNode<BoolT> tmp1815;
    compiler::TNode<BoolT> tmp1816;
    compiler::TNode<Smi> tmp1817;
    compiler::TNode<Context> tmp1818;
    compiler::TNode<Smi> tmp1819;
    compiler::TNode<Smi> tmp1820;
    compiler::TNode<Int32T> tmp1821;
    compiler::TNode<Map> tmp1822;
    compiler::TNode<JSArray> tmp1823;
    compiler::TNode<FixedDoubleArray> tmp1824;
    compiler::TNode<Smi> tmp1825;
    ca_.Bind(&block81, &tmp1801, &tmp1802, &tmp1803, &tmp1804, &tmp1805, &tmp1806, &tmp1807, &tmp1808, &tmp1809, &tmp1810, &tmp1811, &tmp1812, &tmp1813, &tmp1814, &tmp1815, &tmp1816, &tmp1817, &tmp1818, &tmp1819, &tmp1820, &tmp1821, &tmp1822, &tmp1823, &tmp1824, &tmp1825);
    compiler::TNode<Smi> tmp1826;
    USE(tmp1826);
    tmp1826 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(1));
    compiler::TNode<Smi> tmp1827;
    USE(tmp1827);
    tmp1827 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp1825}, compiler::TNode<Smi>{tmp1826}));
    ca_.Goto(&block80, tmp1801, tmp1802, tmp1803, tmp1804, tmp1805, tmp1806, tmp1807, tmp1808, tmp1809, tmp1810, tmp1811, tmp1812, tmp1813, tmp1814, tmp1815, tmp1816, tmp1817, tmp1818, tmp1819, tmp1820, tmp1821, tmp1822, tmp1823, tmp1824, tmp1827);
  }

  if (block79.is_used()) {
    compiler::TNode<Context> tmp1828;
    compiler::TNode<JSArray> tmp1829;
    compiler::TNode<Smi> tmp1830;
    compiler::TNode<JSReceiver> tmp1831;
    compiler::TNode<Object> tmp1832;
    compiler::TNode<Smi> tmp1833;
    compiler::TNode<JSArray> tmp1834;
    compiler::TNode<JSArray> tmp1835;
    compiler::TNode<Map> tmp1836;
    ...
    compiler::TNode<BoolT> tmp1842;
    compiler::TNode<BoolT> tmp1843;
    compiler::TNode<Smi> tmp1844;
    compiler::TNode<Context> tmp1845;
    compiler::TNode<Smi> tmp1846;
    compiler::TNode<Smi> tmp1847;
    compiler::TNode<Int32T> tmp1848;
    compiler::TNode<Map> tmp1849;
    compiler::TNode<JSArray> tmp1850;
    compiler::TNode<FixedDoubleArray> tmp1851;
    compiler::TNode<Smi> tmp1852;
    ca_.Bind(&block79, &tmp1828, &tmp1829, &tmp1830, &tmp1831, &tmp1832, &tmp1833, &tmp1834, &tmp1835, &tmp1836, &tmp1837, &tmp1838, &tmp1839, &tmp1840, &tmp1841, &tmp1842, &tmp1843, &tmp1844, &tmp1845, &tmp1846, &tmp1847, &tmp1848, &tmp1849, &tmp1850, &tmp1851, &tmp1852);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 137);
    BaseBuiltinsFromDSLAssembler(state_).StoreJSObjectElements(compiler::TNode<JSObject>{tmp1850}, compiler::TNode<FixedArrayBase>{tmp1851});
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 120);
    ca_.Goto(&block77, tmp1828, tmp1829, tmp1830, tmp1831, tmp1832, tmp1833, tmp1834, tmp1835, tmp1836, tmp1837, tmp1838, tmp1839, tmp1840, tmp1841, tmp1842, tmp1843, tmp1844, tmp1845, tmp1846, tmp1847, tmp1848, tmp1849, tmp1850);
  }

  if (block76.is_used()) {
    compiler::TNode<Context> tmp1853;
    compiler::TNode<JSArray> tmp1854;
    compiler::TNode<Smi> tmp1855;
    compiler::TNode<JSReceiver> tmp1856;
    compiler::TNode<Object> tmp1857;
    compiler::TNode<Smi> tmp1858;
    compiler::TNode<JSArray> tmp1859;
    compiler::TNode<JSArray> tmp1860;
    compiler::TNode<Map> tmp1861;
    compiler::TNode<BoolT> tmp1862;
    compiler::TNode<BoolT> tmp1863;
    compiler::TNode<BoolT> tmp1864;
    compiler::TNode<FixedArray> tmp1865;
    ...
    compiler::TNode<Int32T> tmp1873;
    compiler::TNode<Map> tmp1874;
    compiler::TNode<JSArray> tmp1875;
    ca_.Bind(&block76, &tmp1853, &tmp1854, &tmp1855, &tmp1856, &tmp1857, &tmp1858, &tmp1859, &tmp1860, &tmp1861, &tmp1862, &tmp1863, &tmp1864, &tmp1865, &tmp1866, &tmp1867, &tmp1868, &tmp1869, &tmp1870, &tmp1871, &tmp1872, &tmp1873, &tmp1874, &tmp1875);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 140);
    compiler::TNode<JSArray> tmp1876;
    USE(tmp1876);
    tmp1876 = ca_.UncheckedCast<JSArray>(BaseBuiltinsFromDSLAssembler(state_).NewJSArray(compiler::TNode<Context>{tmp1870}, compiler::TNode<Map>{tmp1874}, compiler::TNode<FixedArrayBase>{tmp1865}));
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 120);
    ca_.Goto(&block77, tmp1853, tmp1854, tmp1855, tmp1856, tmp1857, tmp1858, tmp1859, tmp1860, tmp1861, tmp1862, tmp1863, tmp1864, tmp1865, tmp1866, tmp1867, tmp1868, tmp1869, tmp1870, tmp1871, tmp1872, tmp1873, tmp1874, tmp1876);
  }
  ...
  if (block77.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp1880;
    compiler::TNode<Object> tmp1881;
    compiler::TNode<Smi> tmp1882;
    compiler::TNode<JSArray> tmp1883;
    compiler::TNode<JSArray> tmp1884;
    compiler::TNode<Map> tmp1885;
    compiler::TNode<BoolT> tmp1886;
    compiler::TNode<BoolT> tmp1887;
    compiler::TNode<BoolT> tmp1888;
    compiler::TNode<FixedArray> tmp1889;
    compiler::TNode<BoolT> tmp1890;
    compiler::TNode<BoolT> tmp1891;
    compiler::TNode<BoolT> tmp1892;
    compiler::TNode<Smi> tmp1893;
    compiler::TNode<Context> tmp1894;
    compiler::TNode<Smi> tmp1895;
    compiler::TNode<Smi> tmp1896;
    compiler::TNode<Int32T> tmp1897;
    compiler::TNode<Map> tmp1898;
    compiler::TNode<JSArray> tmp1899;
    ca_.Bind(&block77, &tmp1877, &tmp1878, &tmp1879, &tmp1880, &tmp1881, &tmp1882, &tmp1883, &tmp1884, &tmp1885, &tmp1886, &tmp1887, &tmp1888, &tmp1889, &tmp1890, &tmp1891, &tmp1892, &tmp1893, &tmp1894, &tmp1895, &tmp1896, &tmp1897, &tmp1898, &tmp1899);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 144);
    compiler::TNode<FixedArray> tmp1900;
    USE(tmp1900);
    tmp1900 = BaseBuiltinsFromDSLAssembler(state_).kEmptyFixedArray();
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 145);
    ca_.Goto(&block64, tmp1877, tmp1878, tmp1879, tmp1880, tmp1881, tmp1882, tmp1883, tmp1884, tmp1885, tmp1886, tmp1887, tmp1888, tmp1900, tmp1890, tmp1891, tmp1892, tmp1893, tmp1894, tmp1895, tmp1899);
  }

  if (block64.is_used()) {
    compiler::TNode<Context> tmp1901;
    compiler::TNode<JSArray> tmp1902;
    compiler::TNode<Smi> tmp1903;
    compiler::TNode<JSReceiver> tmp1904;
    compiler::TNode<Object> tmp1905;
    compiler::TNode<Smi> tmp1906;
    compiler::TNode<JSArray> tmp1907;
    compiler::TNode<JSArray> tmp1908;
    compiler::TNode<Map> tmp1909;
    compiler::TNode<BoolT> tmp1910;
    compiler::TNode<BoolT> tmp1911;
    compiler::TNode<BoolT> tmp1912;
    compiler::TNode<FixedArray> tmp1913;
    compiler::TNode<BoolT> tmp1914;
    compiler::TNode<BoolT> tmp1915;
    compiler::TNode<BoolT> tmp1916;
    compiler::TNode<Smi> tmp1917;
    compiler::TNode<Context> tmp1918;
    compiler::TNode<Smi> tmp1919;
    compiler::TNode<JSArray> tmp1920;
    ca_.Bind(&block64, &tmp1901, &tmp1902, &tmp1903, &tmp1904, &tmp1905, &tmp1906, &tmp1907, &tmp1908, &tmp1909, &tmp1910, &tmp1911, &tmp1912, &tmp1913, &tmp1914, &tmp1915, &tmp1916, &tmp1917, &tmp1918, &tmp1919, &tmp1920);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 215);
    ca_.Goto(&block2, tmp1901, tmp1902, tmp1903, tmp1904, tmp1905, tmp1920);
  }

  if (block2.is_used()) {
    compiler::TNode<Context> tmp1921;
    compiler::TNode<JSArray> tmp1922;
    compiler::TNode<Smi> tmp1923;
    compiler::TNode<JSReceiver> tmp1924;
    compiler::TNode<Object> tmp1925;
    compiler::TNode<JSArray> tmp1926;
    ca_.Bind(&block2, &tmp1921, &tmp1922, &tmp1923, &tmp1924, &tmp1925, &tmp1926);
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 179);
    ca_.Goto(&block88, tmp1921, tmp1922, tmp1923, tmp1924, tmp1925, tmp1926);
  }

  if (block1.is_used()) {
    compiler::TNode<JSArray> tmp1927;
    compiler::TNode<Smi> tmp1928;
    ca_.Bind(&block1, &tmp1927, &tmp1928);
    *label_Bailout_parameter_1 = tmp1928;
    *label_Bailout_parameter_0 = tmp1927;
    ca_.Goto(label_Bailout);
  }

    compiler::TNode<Context> tmp1929;
    compiler::TNode<JSArray> tmp1930;
    compiler::TNode<Smi> tmp1931;
    compiler::TNode<JSReceiver> tmp1932;
    compiler::TNode<Object> tmp1933;
    compiler::TNode<JSArray> tmp1934;
    ca_.Bind(&block88, &tmp1929, &tmp1930, &tmp1931, &tmp1932, &tmp1933, &tmp1934);
  return compiler::TNode<JSArray>{tmp1934};
}
