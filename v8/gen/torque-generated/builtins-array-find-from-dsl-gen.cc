...
TF_BUILTIN(ArrayFindLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:17:61");
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:18:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block5.is_used()) {
    ...
    USE(tmp68);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp68 = BaseBuiltinsFromDSLAssembler(state_).Cast22UT12ATHeapNumber5ATSmi(compiler::TNode<Object>{tmp64}, &label0);
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:19:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block9.is_used()) {
    ...
    USE(tmp105);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp105 = BaseBuiltinsFromDSLAssembler(state_).Cast22UT12ATHeapNumber5ATSmi(compiler::TNode<Object>{tmp101}, &label0);
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:20:57");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayFindLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 33);
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:33:5");
    CodeStubAssembler(state_).Unreachable();
  }
}
...
TF_BUILTIN(ArrayFindLoopAfterCallbackLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 46);
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:46:61");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 47);
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:47:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block5.is_used()) {
    ...
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = BaseBuiltinsFromDSLAssembler(state_).Cast22UT12ATHeapNumber5ATSmi(compiler::TNode<Object>{tmp80}, &label0);
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:48:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/array-find.tq:49:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 56);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 57);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 61);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 60);
...
TF_BUILTIN(ArrayFindLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4, &tmp5, &tmp6);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 69);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 75);
    compiler::TNode<Object> tmp43;
    USE(tmp43);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 80);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 79);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 83);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp74);
    tmp74 = ca_.UncheckedCast<Number>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr22UT12ATHeapNumber5ATSmi17ATconstexpr_int31(1));
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 89);
...
compiler::TNode<Object> ArrayFindBuiltinsFromDSLAssembler::FastArrayFind(compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 95);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 101);
  ...
  if (block37.is_used()) {
    ...
    ca_.Goto(&block2, tmp463, tmp464, tmp465, tmp466, tmp467, tmp477);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 114);
    compiler::TNode<Oddball> tmp525;
    USE(tmp525);
    tmp525 = BaseBuiltinsFromDSLAssembler(state_).Undefined();
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 92);
  ...
  return compiler::TNode<Object>{tmp538};
}
...
USE(parameter1);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, Object, JSReceiver, Number, JSReceiver, Object, JSReceiver, Number, JSReceiver, Object, Object> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 122);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 127);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 130);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 134);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 137);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 140);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 144);
    compiler::TNode<Object> tmp62;
    USE(tmp62);
    compiler::TypedCodeAssemblerVariable<Smi> result_0_0(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp62 = ArrayFindBuiltinsFromDSLAssembler(state_).FastArrayFind(compiler::TNode<Context>{tmp56}, compiler::TNode<JSReceiver>{tmp58}, compiler::TNode<Number>{tmp59}, compiler::TNode<JSReceiver>{tmp60}, compiler::TNode<Object>{tmp61}, &label0, &result_0_0);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 148);
    compiler::TNode<Object> tmp92;
    tmp92 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayFindLoopContinuation, tmp85, tmp87, tmp89, tmp90, tmp87, tmp91, tmp88);
    USE(tmp92);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 152);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 155);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp97}, MessageTemplate::kCalledOnNullOrUndefined, "Array.prototype.find");
  }
}
